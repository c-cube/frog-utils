...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4e4b033a202a36cd0486f0ce7e373c07) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("frog", ["src/lib"], []); ("frog_server", ["src/server"], [])];
     lib_c = [];
     flags = [];
     includes =
       [
          ("src/web_server", ["src/lib"; "src/server"]);
          ("src/server", ["src/lib"]);
          ("src/plot", ["src/lib"; "src/server"]);
          ("src/main", ["src/lib"; "src/server"]);
          ("src/js", ["src/lib"]);
          ("src/irc", ["src/lib"; "src/server"])
       ]
  }
  ;;
