...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4b1d9b9649e42497c9aee58ea0b85678) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-j 0 -plugin-tag 'package(js_of_ocaml.ocamlbuild)'"
         ];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/frog-utils";
          bugreports = None;
          synopsis =
            "Tools for running/testing/benchmarking provers and related logic tools";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build and install the web UI for frogutils";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build and install the IRC daemon for frogutils";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build and install the frogplot tool";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "frog";
                           FindlibPackage ("unix", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.preemptive", None);
                           FindlibPackage ("cmdliner", None);
                           FindlibPackage ("junit", None);
                           FindlibPackage ("maki", None);
                           FindlibPackage ("printbox", None);
                           FindlibPackage ("maki.yojson", None);
                           FindlibPackage ("ISO8601", None);
                           FindlibPackage ("threads", None);
                           FindlibPackage ("sqlexpr", None);
                           FindlibPackage ("sqlexpr.ppx", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/web_server/";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "frog";
                           InternalLibrary "frog_server";
                   ...
                   {exec_custom = false; exec_main_is = "frogweb.ml"});
               Executable
                 ({
                     cs_name = "frogdaemon";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogdaemon.ml"});
               Executable
                 ({
                     cs_name = "frogmonitor";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogmonitor.ml"});
               Executable
                 ({
                     cs_name = "frogtptp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogtptp.ml"});
               Executable
                 ({
                     cs_name = "frogirc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogirc.ml"});
               Executable
                 ({
                     cs_name = "frogtest";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogtest.ml"});
               Executable
                 ({
                     cs_name = "frogplot";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "frogplot.ml"});
               Executable
                 ({
                     cs_name = "froglock";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "froglock.ml"});
               Executable
                 ({
                     cs_name = "frogwebclient";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "frogwebclient.ml"})
            ];
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("make", ["js_links"])))]
            };
     ...
     oasis_digest = Some "\253\004\233]\254\167'D\128\174&\224q\192h\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
